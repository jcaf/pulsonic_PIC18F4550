...
SOURCEFILES_QUOTED_IF_SPACED=main.c ../../../../../../FIRWAR/eslibrary/ikb/ikb.c pulsonic.c mpap.c pump.c display.c nozzle.c inputs.c configMode.c visMode.c autoMode.c error.c ../../../../../../FIRWAR/eslibrary/PIC/eeprom/eeprom.c flushAllMode.c flushAtNozzle.c myeeprom.c ustepping.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/_ext/145479544/ikb.p1 ${OBJECTDIR}/pulsonic.p1 ${OBJECTDIR}/mpap.p1 ${OBJECTDIR}/pump.p1 ${OBJECTDIR}/display.p1 ${OBJECTDIR}/nozzle.p1 ${OBJECTDIR}/inputs.p1 ${OBJECTDIR}/configMode.p1 ${OBJECTDIR}/visMode.p1 ${OBJECTDIR}/autoMode.p1 ${OBJECTDIR}/error.p1 ${OBJECTDIR}/_ext/2002143683/eeprom.p1 ${OBJECTDIR}/flushAllMode.p1 ${OBJECTDIR}/flushAtNozzle.p1 ${OBJECTDIR}/myeeprom.p1 ${OBJECTDIR}/ustepping.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/_ext/145479544/ikb.p1.d ${OBJECTDIR}/pulsonic.p1.d ${OBJECTDIR}/mpap.p1.d ${OBJECTDIR}/pump.p1.d ${OBJECTDIR}/display.p1.d ${OBJECTDIR}/nozzle.p1.d ${OBJECTDIR}/inputs.p1.d ${OBJECTDIR}/configMode.p1.d ${OBJECTDIR}/visMode.p1.d ${OBJECTDIR}/autoMode.p1.d ${OBJECTDIR}/error.p1.d ${OBJECTDIR}/_ext/2002143683/eeprom.p1.d ${OBJECTDIR}/flushAllMode.p1.d ${OBJECTDIR}/flushAtNozzle.p1.d ${OBJECTDIR}/myeeprom.p1.d ${OBJECTDIR}/ustepping.p1.d
...
# Source Files
SOURCEFILES=main.c ../../../../../../FIRWAR/eslibrary/ikb/ikb.c pulsonic.c mpap.c pump.c display.c nozzle.c inputs.c configMode.c visMode.c autoMode.c error.c ../../../../../../FIRWAR/eslibrary/PIC/eeprom/eeprom.c flushAllMode.c flushAtNozzle.c myeeprom.c ustepping.c
...
${OBJECTDIR}/main.p1: main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit2  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 -I"." -I"/run/media/jcaf/pleasure/PROYECTOS/FIRWAR/eslibrary" --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/main.p1  main.c 
...
${OBJECTDIR}/main.p1: main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/main.p1.d 
	@${RM} ${OBJECTDIR}/main.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 -I"." -I"/run/media/jcaf/pleasure/PROYECTOS/FIRWAR/eslibrary" --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/main.p1  main.c 
	@-${MV} ${OBJECTDIR}/main.d ${OBJECTDIR}/main.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/main.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/pulsonic.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/pulsonic.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 -I"." -I"/run/media/jcaf/pleasure/PROYECTOS/FIRWAR/eslibrary" --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD)  -odist/${CND_CONF}/${IMAGE_TYPE}/pulsonic.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
